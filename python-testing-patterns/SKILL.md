...
description: pytest-specific testing patterns — fixtures, mocking, parameterization, async testing, and configuration. Use when writing Python tests with pytest, setting up pytest infrastructure, or needing pytest-specific patterns. For TDD process and philosophy (red-green-refactor, vertical slicing), use the `tdd` skill instead.
---

# Python Testing Patterns

pytest-specific tooling patterns for Python projects. For the TDD process (red-green-refactor, vertical slicing, tracer bullets), see the `tdd` skill — it is language-agnostic and should be used alongside this skill.

## When to Use This Skill

- Writing tests with pytest specifically
- Setting up pytest fixtures, conftest, and configuration
...
- **Integration Tests**: Test interaction between components — prefer these; they exercise real code paths through public APIs
